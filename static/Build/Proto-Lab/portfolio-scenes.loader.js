function createUnityInstance(t, n, c) {
      ...
      (document.addEventListener("webkitfullscreenchange", function(e) {
        document.webkitCurrentFullScreenElement === t
          ? t.style.width &&
            ...
            (t.style.width = "100%"),
            (t.style.height = "100%"))
          : w && ((t.style.width = w), (t.style.height = y), (y = w = ""));
      }),
  ...
  return (
    ...
    (l.UnityCache =
      ((d = { name: "UnityCache", version: 4 }),
      (u = { name: "RequestMetaDataStore", version: 1 }),
      (h = "RequestStore"),
      (f = "WebAssembly"),
      (p =
        window.indexedDB ||
      ...
      (P.UnityCacheDatabase = d),
      (P.RequestMetaDataStore = u),
      ...
      (P.prototype.upgradeDatabase = function(e) {
        ...
        e.objectStoreNames.contains(u.name) ||
          ...
          e.objectStoreNames.contains(h) && e.deleteObjectStore(h),
          e.objectStoreNames.contains(f) && e.deleteObjectStore(f);
      }),
    ...
    (l.cachedFetch =
      ((g = l.UnityCache),
      (b = l.fetchWithProgress),
      (v = l.readBodyWithProgress),
      function(o, a) {
        var e,
          t,
          i = g.getInstance(),
          ...
          return fetch(n, r).then(function(e) {
            ...
            return !c.enabled || c.revalidated
              ...
              ? ((c.revalidated = !0),
                ...
                v(c.response, r.onProgress, r.enableStreamingDownload))
              : 200 == e.status
              ? ((c.response = e),
                (c.metaData.updatedAt = c.metaData.accessedAt),
                (c.revalidated = !0),
                (t = e.clone()),
                v(e, r.onProgress, r.enableStreamingDownload).then(function(e) {
                  return (
              ...
              : (x(
                ...
                v(e, r.onProgress, r.enableStreamingDownload));
          });
        }
        return (
          a &&
                    ...
                    ? ((n = e.response),
                      ...
                      "immutable" == c.control
                        ? ((c.revalidated = !0),
                          ...
                          v(n, a.onProgress, a.enableStreamingDownload))
                        : ((e = s),
                          ((t = window.location.href.match(
                            /^[a-z]+:\/\/[^\/]+/
                          )) &&
                            !e.lastIndexOf(t[0], 0)) ||
                          (!n.headers.get("Last-Modified") &&
                            ...
                            ? ((e = (a = a || {}).headers || {}),
                              (a.headers = e),
                              n.headers.get("Last-Modified")
                                ? ((e["If-Modified-Since"] = n.headers.get(
                                    "Last-Modified"
                                  )),
